...
class  Media
{
 ...
 /*--------------------------------------------------------------*/
  public function process_media()
  {
    ...
    // Check if file type is jpg, jpeg, and png.
    $file_type = $this->fileType; // You already have this assigned in the upload() method.
    if ($file_type != 'image/jpeg' && $file_type != 'image/jpg'  && $file_type != 'image/png') {
      $this->errors[] = 'Only jpg, jpeg, and png file formats are allowed.';
      return false;
    }
